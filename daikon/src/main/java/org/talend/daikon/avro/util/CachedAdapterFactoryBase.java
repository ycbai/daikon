 ...
 */
public abstract class CachedAdapterFactoryBase<ContainerDataSpecT, FieldDataSpecT, GettableT, SettableT>
        implements IndexedRecordAdapterFactory<GettableT, IndexedRecord>, HasNestedAvroConverter<GettableT, IndexedRecord> {
