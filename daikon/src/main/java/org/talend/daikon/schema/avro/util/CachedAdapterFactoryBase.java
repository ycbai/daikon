...
import static org.talend.daikon.schema.avro.util.AvroUtils.*;
...
import org.talend.daikon.schema.avro.container.ContainerReaderByIndex;
import org.talend.daikon.schema.avro.container.ContainerWriterByIndex;
 ...
 */
public abstract class CachedAdapterFactoryBase<FieldDataSpecT, GettableT, SettableT, ContainerDataSpecT> implements
    ...
    public void setSchema(Schema schema) {
        ...
        if (schema != null) {
            ...
            fieldType = (FieldDataSpecT[]) Array.newInstance(fieldDataSpecClass, unwrapIfNullable(schema).getFields().size());
